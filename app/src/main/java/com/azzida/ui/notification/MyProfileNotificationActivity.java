...
import com.azzida.ui.activity.DisputeActivity;
import com.azzida.ui.activity.EditProfileActivity;
import com.azzida.ui.activity.JobListerDetailActivity;
import com.azzida.ui.activity.JobSeekerApplyActivity;
import com.azzida.ui.activity.ListingActivity;
import com.azzida.ui.activity.LoginActivity;
import com.azzida.ui.activity.MainActivity;
import com.azzida.ui.activity.MyJobActivity;
import com.azzida.ui.activity.OptionsActivity;
import com.azzida.ui.activity.PaymentInfoActivity;
import com.azzida.ui.activity.TransactionDetailsActivity;
...
public class MyProfileNotificationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void InitView() {
        ...
        final LinearLayoutManager mLayoutManager = new GridLayoutManager(MyProfileNotificationActivity.this, 1);
        ...
        final LinearLayoutManager mLayoutManage = new GridLayoutManager(MyProfileNotificationActivity.this, 1);
    ...
    private void getProfile() {
        ...
        Utils.showProgressdialog(MyProfileNotificationActivity.this, "Please Wait....");

        ApiService service = ApiClient.getClient().create(ApiService.class);
        String s_userId = AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_User_ID);
...
*/
                                ...
                                AppPrefs.setBooleanKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_Azzida_Verified, AzzidaVerified);

                                accountNo = result.getData().getStripeAccId();

                                txt_Availablebalance.setVisibility(View.VISIBLE);

                                AppPrefs.setStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_StripeAccId, result.getData().getStripeAccId());

                                AppPrefs.setStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_Balance, result.getData().getBalance().replaceAll("\\.0*$", ""));
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(MyProfileNotificationActivity.this);
                    ...
                    // Server Problem
                    Toast.makeText(MyProfileNotificationActivity.this, R.string.ServerUnderMaintenance, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == ADD_ACCOUNT) {
            ...
            RetrieveStripeAccount(DataManager.getInstance().getStripeCode(), AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_User_ID), "");
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.getStatus().equals("1")) {
                        if (result.getData() != null) {
                            ...
                            recentJobsPostedAdpater = new RecentJobsPostedAdpater(MyProfileNotificationActivity.this, new RecentJobsPostedAdpater.ClickView() {
                                @Override
                                public void clickitem(View view, final int position) {

                                    Intent myIntent = new Intent(MyProfileNotificationActivity.this, JobListerDetailActivity.class);
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.getStatus().equals("1")) {
                        if (result.getData() != null) {
                            ...
                            recentJobsAppliedAdpater = new RecentJobsAppliedAdpater(MyProfileNotificationActivity.this, new RecentJobsAppliedAdpater.ClickView() {
                                @Override
                                public void clickitem(View view, final int position) {

                                    Intent myIntent = new Intent(MyProfileNotificationActivity.this, JobSeekerApplyActivity.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.profile_back:
                ...
                Intent intent = new Intent(MyProfileNotificationActivity.this,
                        MainActivity.class);
            ...
            case R.id.edit_Cashout:
                ...
                if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
                        AppPrefs.KEY_USER_LOGIN_DEMO).
                        equalsIgnoreCase("false")) {

                    String AccountId = AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_StripeAccId);
                    ...
                    if (!receivedAmount.equals("0") && !receivedAmount.equals("0.00") && !receivedAmount.equals("0.0")) {
                        ...
                        if (AccountId.length() > 0) {
                            ...
                            AlertDialog.Builder Cashout = new AlertDialog.Builder(MyProfileNotificationActivity.this);

                            CardView CashOutview = (CardView) MyProfileNotificationActivity.this.getLayoutInflater().inflate(R.layout.dialog_cash_out, null);
                            ...
                            AlertDialog.Builder buildernw = new AlertDialog.Builder(MyProfileNotificationActivity.this);
                                            ...
                                            AlertDialog.Builder builder = new AlertDialog.Builder(MyProfileNotificationActivity.this)
                                                    ...
                                                    .setPositiveButton("Link Existing Account", new DialogInterface.OnClickListener() {
                                                        ...
                                                        public void onClick(DialogInterface dialogInterface, int i) {
                                                            ...
                                                            AlertDialog.Builder Account = new AlertDialog.Builder(MyProfileNotificationActivity.this);

                                                            CardView Accountview = (CardView) MyProfileNotificationActivity.this.getLayoutInflater().inflate(R.layout.dialog_account, null);
                                                            ...
                                                            btn_submit.setOnClickListener(new View.OnClickListener() {
                                                                ...
                                                                public void onClick(View view) {
                                                                    ...
                                                                    if (validateAccount(edt_account_no.getText().toString())) {
                                                                        ...
                                                                        RetrieveStripeAccount("", AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_User_ID), edt_account_no.getText().toString());
                                                    ...
                                                    .setNegativeButton("Create New Account", new DialogInterface.OnClickListener() {
                                                        ...
                                                        public void onClick(DialogInterface dialogInterface, int i) {
                                                            dialogInterface.cancel();
                                                            Intent myIntent = new Intent(MyProfileNotificationActivity.this, StripeConnect.class);
            ...
            case R.id.edit_profile:
                ...
                if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
                    ...
                    Intent edit_profile = new Intent(MyProfileNotificationActivity.this, EditProfileActivity.class);
            ...
            case R.id.edit_payment_info:
                ...
                if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
                    ...
                    Intent edit_payment_info = new Intent(MyProfileNotificationActivity.this, PaymentInfoActivity.class);
            ...
            case R.id.edit_payment_history:
                ...
                if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
                    ...
                    Intent edit_payment_history = new Intent(MyProfileNotificationActivity.this, TransactionDetailsActivity.class);
            ...
            case R.id.my_listings:
                ...
                if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
                    ...
                    Intent my_listings = new Intent(MyProfileNotificationActivity.this, ListingActivity.class);
            ...
            case R.id.my_job:
                ...
                if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
                    ...
                    Intent my_job = new Intent(MyProfileNotificationActivity.this, MyJobActivity.class);
            ...
            case R.id.Dispute_Resolution:
                ...
                if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
                    ...
                    Intent Dispute_Resolution = new Intent(MyProfileNotificationActivity.this, DisputeActivity.class);
    ...
    private void CallOption() {
        ...
        if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
            ...
            Intent edit_payment_history = new Intent(MyProfileNotificationActivity.this, OptionsActivity.class);
            startActivity(edit_payment_history);
            ...
            public void onResponse(@NonNull Call<SuccessModel> call, @NonNull Response<SuccessModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.getStatus().equals("1")) {
                        ...
                        AppPrefs.setStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_StripeAccId, AccountNo);
    ...
    private void setComplete() {
        ...
        builder.setMessage("Account Link Successfully")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.cancel();
                        Intent myIntent = new Intent(MyProfileNotificationActivity.this, MainActivity.class);
                        startActivity(myIntent);
                        finish();
                    }
                });
            ...
            public void onResponse(@NonNull Call<SuccessModel> call, @NonNull Response<SuccessModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.getStatus().equals("1")) {
                        ...
                        AppPrefs.setStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_USER_SIGNUP_ID, "");
    ...
    public void onResume() {
        ...
        if (AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this,
            ...
            String s_firstName = AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_User_FirstName);
            String s_lastName = AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_User_LastName);

            String s_ProfileImage = AppPrefs.getStringKeyvaluePrefs(MyProfileNotificationActivity.this, AppPrefs.KEY_User_ProfileImage);
