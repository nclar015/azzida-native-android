...
public class JobListerDetailActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {

    LinearLayout Applicant, Confirmed, PendingConfirmation, CancelJob, CancelApplication, CancelJobNe, CancelJob1, RePostJob, Completed;

    ImageView img_back_feed, img_share, img_chat;
    ViewPager viewPager;
    ...
    private String JobId, SeekerId, SeekerProfile, SeekerName, Amount, AmountAdmin, TitleName, paymentId, TipId;
...
*/
    ...
    private void initView() {
        ...
        CancelApplication = findViewById(R.id.CancelApplication);
        ...
        CancelApplication.setOnClickListener(this);
    ...
    private void getJobDetail(String JobId) {
        ...
        final ProgressDialog progressdialog = new ProgressDialog(JobListerDetailActivity.this);
                        ...
                        if (result.getData() != null) {
                            ...
                            if (result.getData().getJobId() != null) {
                                ...
                                if (result.getData().getApplicationAccepted()) {
                                    ...
                                    CancelApplication.setVisibility(View.VISIBLE);
                                    ...
                                    CancelApplication.setVisibility(View.GONE);
                                ...
                                if (result.getData().getOfferAccepted()) {
                                    ...
                                    CancelJobNe.setVisibility(View.VISIBLE);
                                    PendingConfirmation.setVisibility(View.GONE);
                                    CancelJob.setVisibility(View.GONE);
                                    CancelApplication.setVisibility(View.GONE);
                                    img_chat.setVisibility(View.VISIBLE);
                                ...
                                if (JobComplete) {
                                    ...
                                    if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                                        Confirmed.setBackgroundDrawable(ContextCompat.getDrawable(JobListerDetailActivity.this, R.drawable.border_green));
                                    } else {
                                        Confirmed.setBackground(ContextCompat.getDrawable(JobListerDetailActivity.this, R.drawable.border_green));
                                    }
                                    CancelJobNe.setVisibility(View.GONE);
                                    CancelJob.setVisibility(View.GONE);
                                    CancelApplication.setVisibility(View.GONE);
...
*/
                                ...
                                if (arrayImageList.size() > 0) {
                                    ...
                                    viewPagerAdapter = new ViewPagerAdapter(arrayImageList, JobListerDetailActivity.this);
                                    ...
                                    for (int i = 0; i < dotscount; i++) {
                                        ...
                                        dots[i] = new ImageView(JobListerDetailActivity.this);
                                        dots[i].setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.nonactive_dot));
...
*/
                                ...
                                latitude = Double.parseDouble(AppPrefs.getStringKeyvaluePrefs(JobListerDetailActivity.this, AppPrefs.KEY_LAT));

                                longitude = Double.parseDouble(AppPrefs.getStringKeyvaluePrefs(JobListerDetailActivity.this, AppPrefs.KEY_LONG));
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(JobListerDetailActivity.this);
                    ...
                    // Server Problem
                    Toast.makeText(JobListerDetailActivity.this, R.string.ServerUnderMaintenance, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.img_chat:
                ...
                Intent Chat = new Intent(JobListerDetailActivity.this, ChatActivity.class);
            ...
            case R.id.img_share:
                ...
                Utils.createDynamicLink_Advanced(JobListerDetailActivity.this, JobId,
                        AppPrefs.getStringKeyvaluePrefs(JobListerDetailActivity.this, AppPrefs.KEY_User_ID),"Here's a job posting that may be of interest to you");
            ...
            case R.id.txt_editJob:
                ...
                Intent myIntent = new Intent(JobListerDetailActivity.this, EditJobActivity.class);
            ...
            case R.id.Applicant:
                ...
                Intent Intent1 = new Intent(JobListerDetailActivity.this, ApplicantActivity.class);
            ...
            case R.id.RePostJob:
                ...
                AlertDialog.Builder RePost = new AlertDialog.Builder(JobListerDetailActivity.this);

                CardView RePostview = (CardView) JobListerDetailActivity.this.getLayoutInflater().inflate(R.layout.dialog_job_repost, null);
                ...
                edt_select_date.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        datePickerDialog = new DatePickerDialog(JobListerDetailActivity.this, date, myCalendar
                ...
                date = new DatePickerDialog.OnDateSetListener() {
                    ...
                    private void updateLabel() {
                        ...
                        edt_select_date.setTextColor(ContextCompat.getColor(JobListerDetailActivity.this, R.color.black));
                ...
                btn_submit_repost.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        String status = NetworkUtils.getConnectivityStatus(JobListerDetailActivity.this);
                        if (status.equals("404")) {
                            Toast.makeText(JobListerDetailActivity.this, R.string.CheckYourInternetConnection, Toast.LENGTH_SHORT).show();
                        } else {
                            if (validatedate()) {
            ...
            case R.id.Confirmed:
                ...
                if (JobComplete) {
                    ...
                    Intent Confirmed = new Intent(JobListerDetailActivity.this, JobCompleteActivity.class);
    ...
    private void CancelJobPopUp(String msg) {
        ...
        AlertDialog.Builder b1 = new AlertDialog.Builder(JobListerDetailActivity.this);

        CardView view1 = (CardView) JobListerDetailActivity.this.getLayoutInflater().inflate(R.layout.dialog_job_cancel, null);

        Button btn_close1 = view1.findViewById(R.id.btn_close);

        Button btn_submit1 = view1.findViewById(R.id.btn_submit);
        TextView txt_cancelText = view1.findViewById(R.id.txt_cancelText);
        ...
        edt_Cancellation_Reason = view1.findViewById(R.id.edt_Cancellation_Reason);
...
/*                        if (Utils.getDateDiffString(Jobdate, new Date()) < 24) {
    ...
    private void CancelJobPopUpNew(String msg) {
        ...
        AlertDialog.Builder b11 = new AlertDialog.Builder(JobListerDetailActivity.this);

        CardView view11 = (CardView) JobListerDetailActivity.this.getLayoutInflater().inflate(R.layout.dialog_job_cancel, null);
...
/*                        if (Utils.getDateDiffString(Jobdate, new Date()) < 24) {
    ...
    private void getSaveCard() {
        ...
        String s_userId = AppPrefs.getStringKeyvaluePrefs(JobListerDetailActivity.this, AppPrefs.KEY_User_ID);
        ApiService service = ApiClient.getClient().create(ApiService.class);
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.getStatus().equals("1")) {
                        if (result.getData() != null) {
                            ...
                            getSaveCardAdpater = new GetSaveCardAdpater(JobListerDetailActivity.this, new GetSaveCardAdpater.ClickView() {
                                @Override
                                public void clickitem(View view, final int position) {

                                    try {

                                        String s_Balance = AppPrefs.getStringKeyvaluePrefs(JobListerDetailActivity.this, AppPrefs.KEY_Balance);
                                        String CancelAmount = "";
        ...
        if (status.equals("404")) {
            ...
            try {
                ...
                if (bal2 > bal1) {
                    ...
                    AlertDialog.Builder b = new AlertDialog.Builder(JobListerDetailActivity.this, R.style.MyCustomTheme);

                    LinearLayout PaymentView = (LinearLayout) JobListerDetailActivity.this.getLayoutInflater().inflate(R.layout.dialog_payment, null);
                    ...
                    Txt_Direct_PAy.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Card.cancel();
                            Intent myIntent = new Intent(JobListerDetailActivity.this, PaymentCheckOut.class);
                        ...
                        if (result.getData() != null) {
                            if (result.getData().getId() != null) {
                                ...
                                if (result.getData().getIsSuccess()) {
                                    ...
                                    AppPrefs.setStringKeyvaluePrefs(JobListerDetailActivity.this, AppPrefs.KEY_Balance, result.getData().getRefBalance().replaceAll("\\.0*$", ""));
